...
class Question(models.Model):
    ...
    @staticmethod
    def get_unanswered(organization):
        return Question.objects.filter(organization=organization, has_accepted_answer=False)

    @staticmethod
    def get_answered(organization):
        return Question.objects.filter(organization=organization, has_accepted_answer=True)
